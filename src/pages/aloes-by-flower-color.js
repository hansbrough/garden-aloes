...
const FlowerColorPage = ({data}) => {
  return (
    <Layout>
      ...
      <h1>Aloes organized by flower color</h1>
      ...
      <ul>
        <li>
          <h2 style={{fontSize:`1.5rem`, marginTop: `.5rem`, marginBottom: `.25rem` }}>White Flowers</h2>
        ...
        <li>
          <h2 style={{fontSize:`1.5rem`, marginTop: `.5rem`, marginBottom: `.5rem` }}>Orange Flowers</h2>
        ...
        <li>
          <h2 style={{fontSize:`1.5rem`, marginTop: `.5rem`, marginBottom: `.25rem` }}>Red Flowers</h2>
        ...
        <li>
          <h2 style={{fontSize:`1.5rem`, marginTop: `.5rem`, marginBottom: `.25rem` }}>Yellow Flowers</h2>
        ...
        <li>
          <h2 style={{fontSize:`1.5rem`, marginTop: `.5rem`, marginBottom: `.25rem` }}>Salmon Flowers</h2>
